...
local arch_monitor_scale = 1.6
hl.monitor({ output = "", mode = "preferred", position = "auto", scale = arch_monitor_scale })
...
-- sizes X11/XWayland windows, which Arch leaves unscaled so they stay
...
local arch_gdk_scale = 2
hl.env("GDK_SCALE", tostring(arch_gdk_scale))
