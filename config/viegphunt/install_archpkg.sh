...
pacman_packages=(
    ...
    hyprland hyprlock awww grim slurp swaync rofi rofi-emoji yad hyprshot xdg-desktop-portal-hyprland xdg-desktop-portal xdg-desktop-portal-wlr xdg-desktop-portal-gtk
