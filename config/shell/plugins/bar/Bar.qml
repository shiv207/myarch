...
Item {
  ...
  // Hyprland's active gaps_out is 4px; add a 4px inward nudge.
  readonly property int windowOuterGap: 8
  ...
  component BarPanel: PanelWindow {
    ...
    Component {
      ...
      Item {
        ...
        CenterModules { id: centerMods; anchors.centerIn: parent }

        Rectangle {
          id: leftPill
          anchors.left: parent.left
          anchors.leftMargin: root.windowOuterGap
          anchors.verticalCenter: parent.verticalCenter
          height: parent.height
          color: Util.alpha(root.background, 0.9)
          radius: height / 2
          width: leftMods.width + 30
        ...
        Rectangle {
          ...
          anchors.rightMargin: root.windowOuterGap
          anchors.verticalCenter: parent.verticalCenter
          height: parent.height
          color: Util.alpha(root.background, 0.9)
          radius: height / 2
          width: rightMods.width + 30
  ...
  component CenterModules: Item {
    ...
    Component {
      ...
      Item {
        ...
        // Unified center pill background, anchored to the real module items so
        // it always fits the content (Date / Time / Weather / indicators).
        Rectangle {
          id: centerPillBg
          z: -1
          radius: 12
          ...
          height: root.barSize
          anchors.verticalCenter: parent.verticalCenter
          anchors.left: beforeList.left
          anchors.right: afterList.right
          anchors.leftMargin: -15
          anchors.rightMargin: -15
        }

        Rectangle {
          id: centerPillBgSingle
          z: -1
          radius: 12
          color: Util.alpha(root.background, 0.9)
          visible: !centerRoot.hasAnchor
          height: root.barSize
          anchors.verticalCenter: parent.verticalCenter
          anchors.left: centerList.left
          anchors.right: centerList.right
          anchors.leftMargin: -15
          anchors.rightMargin: -15
        }
