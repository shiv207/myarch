                ...
                delegate: Rectangle {
                  ...
                  Row {
                    ...
                    Rectangle {
                      ...
                      Image {
                        anchors.fill: parent
                        source: row.previewImage ? (row.previewImage.indexOf("://") < 0 ? "file://" + row.previewImage : row.previewImage) : ""
                        sourceSize.width: thumbContainer.height * 2
                        sourceSize.height: thumbContainer.height * 2
                    ...
                    Text {
                      width: parent.width - (thumbContainer.visible ? thumbContainer.width + parent.spacing : 0)
                      height: parent.height
